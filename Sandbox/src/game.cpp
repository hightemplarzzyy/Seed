...
public:
	EditorLayer()
		: m_ClearColor{ 0.3f, 0.8f, 0.1f, 1.0f }, m_Scene(Scene::Spheres),
	...
	virtual void OnAttach() override
	{
		...
		m_Mesh.reset(new Seed::Mesh("assets/meshes/cerberus.fbx"));
		m_SphereMesh.reset(new Seed::Mesh("assets/models/Sphere.fbx"));
	...
	virtual void OnUpdate() override
	{
		...
		Seed::UniformBufferDeclaration<sizeof(mat4) * 2 + sizeof(vec3) * 4 + sizeof(float) * 8, 14> simplePbrShaderUB;
...
private:
	...
	std::unique_ptr<Seed::Shader> m_PBRShader;
	std::unique_ptr<Seed::Shader> m_SimplePBRShader;
	std::unique_ptr<Seed::Shader> m_QuadShader;
	std::unique_ptr<Seed::Shader> m_HDRShader;
	std::unique_ptr<Seed::Mesh> m_Mesh;
	std::unique_ptr<Seed::Mesh> m_SphereMesh;
	std::unique_ptr<Seed::Texture2D> m_BRDFLUT;

	struct AlbedoInput
	{
		glm::vec3 Color = { 0.972f, 0.96f, 0.915f }; // Silver, from https://docs.unrealengine.com/en-us/Engine/Rendering/Materials/PhysicallyBased
		std::unique_ptr<Seed::Texture2D> TextureMap;
		bool SRGB = true;
	...
	std::unique_ptr<Seed::Framebuffer> m_Framebuffer, m_FinalPresentBuffer;

	std::unique_ptr<Seed::VertexBuffer> m_VertexBuffer;
	std::unique_ptr<Seed::IndexBuffer> m_IndexBuffer;
	std::unique_ptr<Seed::TextureCube> m_EnvironmentCubeMap, m_EnvironmentIrradiance;
	...
	// Editor resources
	std::unique_ptr<Seed::Texture2D> m_CheckerboardTex;
};
